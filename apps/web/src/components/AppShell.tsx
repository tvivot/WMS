...
const ITEMS: NavItem[] = [
  ...
  { to: '/motivos', label: 'Motivos', icon: Tags, permiso: PERMISOS.MOTIVO_ADMINISTRAR },
  { to: '/notificaciones', label: 'Notificaciones', icon: Mail, permiso: PERMISOS.NOTIFICACIONES_ADMINISTRAR },
